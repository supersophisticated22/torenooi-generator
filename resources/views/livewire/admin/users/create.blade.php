<section class="w-full max-w-2xl">
    <flux:heading>{{ __('Create user') }}</flux:heading>
    <flux:subheading>{{ __('Create a regular platform user.') }}</flux:subheading>
    ...
    <form wire:submit="save" class="mt-6 space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <flux:select wire:model="role" :label="__('Initial role')">
